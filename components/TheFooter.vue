<template>
  <footer class="bg-white">
    <div class="max-w-screen-xl mx-auto py-4 px-4 md:px-6 lg:py-6 lg:px-8">
      <!-- Spacer -->
      ...
      <div class="grid grid-cols-1 gap-2 md:grid-cols-4 md:gap-8">
        ...
        <div class="mt-8">
          ...
          <div id="social-links" class="mt-8 flex justify-center md:justify-start w-full">
            <a href="https://www.facebook.com/colivme" class="text-gray-600 hover:text-gray-700">
            ...
            <a href="https://www.instagram.com/colivme/" class="ml-6 text-gray-600 hover:text-gray-700">
            ...
            <a href="https://twitter.com/colivme" class="ml-6 text-gray-600 hover:text-gray-700">
            ...
            <a href="https://www.linkedin.com/company/colivme/about/" class="ml-6 text-gray-600 hover:text-gray-700">
          ...
          <div class="flex flex-col flex-wrap items-center md:items-start w-full">
            ...
            <span class="inline-flex rounded-md mt-8 w-auto">
              <a href="mailto:hello@colivme.com">
        ...
        <div class="mt-8 hidden md:block">
          ...
          <ul class="mt-4">
            <li>
              <a href="https://colivme.com/documents/ColivMe_CGU_vFR.pdf" class="text-base leading-6 text-gray-700 hover:text-gray-700">
                CGU
              </a>
            </li>
            <li class="mt-4">
              <a href="https://data-privacy.realestate.bnpparibas/" class="text-base leading-6 text-gray-700 hover:text-gray-700">
                Protection des données
              </a>
            </li>
            <li class="mt-4">
              <a href="#cookieControl__ModalContent" class="text-base leading-6 text-gray-700 hover:text-gray-700" @click="$cookies.modal = true">
                Cookies
              </a>
            </li>
            <li class="mt-4">
              <a href="/sitemap.xml" class="text-base leading-6 text-gray-700 hover:text-gray-700">
                Plan du site
              </a>
            </li>
          </ul>
