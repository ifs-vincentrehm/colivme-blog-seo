      ...
      <div class="relative flex justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-end">
          ...
          <div class="flex-shrink-0 flex flex-none lg:flex-1 items-center">
            <img class="block lg:hidden h-8 w-auto lazyload" data-src="~/assets/img/logos/logo-colivme-web.svg" alt="Workflow logo" />
            <img class="hidden lg:block h-8 w-auto lazyload" data-src="~/assets/img/logos/logo-colivme-web.svg" alt="Workflow logo" />
          </div>
