<template>
      ...
      <div class="relative flex justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-end">
          ...
          <div class="hidden sm:ml-6 sm:flex">
            <a href="#" class="navbar-first-link focus:outline-none focus:border-indigo-700">
              {{ links[0] }}
            </a>
  ...
  -->
    <div class="hidden sm:hidden">
      <div class="pt-2 pb-4">
        <a href="#" class="navbar-mobile-first-link focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700">
          {{ links[0] }}
        </a>
...
<style>
.navbar-first-link {
  @apply inline-flex items-center px-1 pt-1 border-b-2 border-indigo-500 text-lg font-medium leading-5 text-gray-900 transition duration-150 ease-in-out;
}
...
.navbar-mobile-first-link {
  @apply block pl-3 pr-4 py-2 border-l-4 border-indigo-500 text-base font-medium text-indigo-700 bg-indigo-50 transition duration-150 ease-in-out;
}
